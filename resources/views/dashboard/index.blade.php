...
<body>
    <div class="container dashboard-container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-column">
                    ...
                    <a href="{{ route('pendaftaran.create.wali') }}" class="btn btn-custom mb-2"><i class="fas fa-user-shield"></i> Isi Form Pendaftaran Data Wali (JIKA SISWA TIDAK TINGGAL DENGAN ORANG TUA)</a>
                    <a href="{{ route('pendaftaran.create.program') }}" class="btn btn-custom mb-2"><i class="fas fa-pencil-alt"></i> Isi Form Program Kelas (Setelah mengisi formulir data siswa dan orang tua)</a>
        ...
        <div class="info-section">
            ...
            <li>Cetak Formulir Pendaftaran Online PPDB MIN 1 Kota Tangsel</li>
