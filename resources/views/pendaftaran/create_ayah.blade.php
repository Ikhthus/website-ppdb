...
<body>
  <div class="container mt-5">
    <div class="card p-4">
      ...
      <form action="{{ route('pendaftaran.store.ayah') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="nomor_kks" name="nomor_kks">
        </div>
        <div class="form-group">
          <label for="nomor_pkh">Nomor PKH (JIKA ADA):</label>
          <input type="text" class="form-control" id="nomor_pkh" name="nomor_pkh">
        </div>
